// Primer programa de JS
// alert genera un pequeño mensaje en el browser
// alert("Welcome to your bank");
// Podemos utilizar el prompt para sacar una variable tipo string
// var deposit = prompt("How much would you like to deposit today");
// alert funciona como un print de py
// alert("You have deposited " + deposit)
// Los console logs van (obviamente) a la consola
// console.log("Yo' how you doin?")

// Haciendo el ejercicio de cnvertir libras a Kg
// Primero se necesita pedir el numero y castearlo como numero
// var lb = parseFloat(prompt("Cuantas libras a Kg: "));
// alert(lb.toString() + " libras son " + (lb*0.454).toString() + " Kg");
...
var simple = {
    prop: "Hello",
    method: function(){
        console.log("Llamaste al metodo")
    }
}
...
function caught_speeding(speed, is_birthday){
    var tolerance = (is_birthday) ? 5 : 0;
    if(speed <= 60 + tolerance){return 0;}
    else if(speed > 60 && speed <= 80 + tolerance){return 1;}
    else{return 2;}
}
...
function makeBricks(small, big, goal){
    var loose = goal % 5;
    if(goal/5 <= big  && loose <= small){ return true;}
    else{return false;}
    //Code Goes Here
  }
